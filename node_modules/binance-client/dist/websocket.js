...
var tradesInternal = function tradesInternal(payload, streamName, outputMap, cb) {
  var cache = (Array.isArray(payload) ? payload : [payload]).map(function (symbol) {
...
var aggTrades = function aggTrades(payload, cb) {
  return tradesInternal(payload, 'aggTrade', aggTradesOutputMapping, cb);
};
...
var trades = function trades(payload, cb) {
  return tradesInternal(payload, 'trade', tradesOutputMapping, cb);
};
  ...
  return function (cb) {
    ...
    var makeStream = function makeStream(isReconnecting) {
      return new Promise(function (resolve) {
        getDataStream().then(function (_ref2) {
